package org.example.test.hipster.repository;

import org.example.test.hipster.HipsterApp;

import org.example.test.hipster.config.Constants;
import org.example.test.hipster.config.audit.AuditEventConverter;
import org.example.test.hipster.domain.PersistentAuditEvent;
...
import static org.example.test.hipster.repository.CustomAuditEventRepository.EVENT_DATA_COLUMN_MAX_LENGTH;
